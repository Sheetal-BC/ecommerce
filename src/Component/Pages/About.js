  ...
  return (
    <Fragment>
      <div className="about">
        ...
        <div className="divi">
          <img
            src="https://media.istockphoto.com/id/1277145238/photo/large-variety-of-multi-colored-dried-tea-leaves-and-flowers-on-the-table.jpg?s=612x612&w=0&k=20&c=e37c4_5934iFqFcuhTJIMNiW4vCoSvNGw6ZjgzW4COs="
            alt="about"
            className="picture"
          />
